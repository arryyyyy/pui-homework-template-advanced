...
function Roll({ type, basePrice, addToCart, resetSelections }) {
            ...
            <div className="options">
                ...
                {[1, 3, 6, 12].map(size => (
                    <div key={size}>
                        ...
                        />
                        <label 
                            className="pack-size-label" 
                            htmlFor={`pack-size-${size}-${type}`}
                            style={{backgroundColor: packSize == size ? 'rgb(187, 187, 187)' : 'white'}}
                        >
                            {size}
                        </label>
                    </div>
